...
```
* 注册用户信息
* Address: http://api.link97.com:8085/user/register
...
```
* 用户登录
* Address: http://api.link97.com:8085/user/login
* 参数: email、password
* Type: String 
* required: true
* Methods: POST
...
```
* token验证
* Address: http://api.link97.com:8085/user/current
* 参数: null
* Type: null 
* required: false
* Methods: GET
...
```
* 添加个人工作经历
* Address: http://api.link97.com:8085/profile/experience
...
```
* 添加个人教育经历
* Address: http://api.link97.com:8085/profile/education
...
```
* 查看所有简历
* Address: http://api.link97.com:8085/profile/queryall
...
```
* 查看单个简历
* Address: http://api.link97.com:8085/profile/idget
...
```
* 根据用户名(handle)查询
* Address: http://api.link97.com:8085/profile/handlequery
...
```
* 删除单个工作经历
* Address: http://api.link97.com:8085/profile/del_experience
* 参数: {delId:_id }
* Type:String
* required: true
* Methods: DELETE
...
```
* 删除单个教育经历
* Address: http://api.link97.com:8085/profile/del_education
* 参数: {delId:_id }
* Type:String
* required: true
* Methods: DELETE
...
```
* 删除当前用户所有信息
* Address: http://api.link97.com:8085/profile/del_all
* 参数: {delAllId:_id }
* Type:String
* required: true
* Methods: DELETE
...
```
* 用户评论接口 
* Address: http://api.link97.com:8085/posts/comment
* 参数: text
* Type:String
* required: true
* Methods: POST
...
```
* 用户评论接口 
* Address: http://api.link97.com:8085/posts/all_getComment
...
```
* 查询当前用户所有评论的接口 
* Address: http://api.link97.com:8085/posts/getUserComment
* 参数: null
* Type: null  
* required: false
* Methods: POST
...
```
* 根据id查询当前评论的接口 
* Address: http://api.link97.com:8085/posts/commentId
* 参数: {commentId:'id'}
* Type: String  
* required: true
* Methods: POST
...
```
* 根据评论id删除当前评论接口
* Address: http://api.link97.com:8085/posts/del_comment
* 参数: {del_id:'id'}
* Type: String  
* required: true
* Methods: DELETE
...
```
* 当前用户点赞接口
* Address: http://api.link97.com:8085/posts/likes
* 参数: {likeIds:'id'}
* Type: String  
* required: true
* Methods: POST
...
```
* 当前用户取消点赞接口
* Address: http://api.link97.com:8085/posts/unlikes
* 参数: {unlikeId:'id'}
* Type: String  
* required: true
* Methods: POST
...
```
* 当前用户回复其他用户的评论
* Address: http://api.link97.com:8085/posts/commentChild
...
```
* 当前用户回复其他用户的评论
* Address: http://api.link97.com:8085/posts/commentRemoveChild
